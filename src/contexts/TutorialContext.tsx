...
export const SESSION_STEPS: TutorialStep[] = [
  ...
  },
  {
    ...
    body: 'When you\'re done, tap Finish to review and save your session.',
    screen: 'activeSession',
    skipIfMissing: true,
  },
  {
    targetId: 'tutorial-discard-btn',
    title: 'Or Discard',
    body: 'Started a workout by mistake? Tap Discard to throw it away without saving. Happy lifting!',
    screen: 'activeSession',
    skipIfMissing: true,
  },
];
