...
export const EXERCISE_DATABASE: Exercise[] = [
  ...
  { id: 'pallof-press', name: 'Pallof Press', primaryBodyPart: 'Core', equipment: 'Cable', difficulty: 'Beginner', exerciseType: 'Isolation', movementPattern: 'Anti-Rotation', secondaryMuscles: ['Obliques', 'Shoulders'], aliases: ['cable pallof press', 'palov press', 'palof press', 'anti-rotation press'] },
  { id: 'band-pallof-press', name: 'Band Pallof Press', primaryBodyPart: 'Core', equipment: 'Band', difficulty: 'Beginner', exerciseType: 'Isolation', movementPattern: 'Anti-Rotation', secondaryMuscles: ['Obliques', 'Shoulders'], aliases: ['banded pallof press', 'palov press band'] },
  ...
  { id: 'ab-wheel-rollout', name: 'Ab Wheel Rollout', primaryBodyPart: 'Core', equipment: 'Bodyweight', difficulty: 'Advanced', exerciseType: 'Compound', movementPattern: 'Isometric', secondaryMuscles: ['Lats', 'Shoulders', 'Hip Flexors'], aliases: ['ab rollout', 'ab wheel', 'wheel rollout', 'rollout'] },
  { id: 'suspension-reverse-rollout', name: 'Suspension Reverse Ab Rollout', primaryBodyPart: 'Core', equipment: 'TRX/Suspension', difficulty: 'Advanced', exerciseType: 'Compound', movementPattern: 'Isometric', secondaryMuscles: ['Lats', 'Shoulders', 'Hip Flexors'], aliases: ['trx reverse ab rollout', 'trx rollout', 'suspension trainer reverse ab rollout', 'reverse rollout'] },
  ...
  { id: 'jump-turns-180', name: '180 Jump Turns', primaryBodyPart: 'Full Body', equipment: 'Bodyweight', difficulty: 'Intermediate', exerciseType: 'Compound', movementPattern: 'Plyometric', secondaryMuscles: ['Quads', 'Glutes', 'Calves', 'Core'], aliases: ['jump turn 180', 'half turn jump', '180 degree jump', 'rotational jump'] },
